                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                      {project.playStore && (
                        <a
                          ...
                          className="flex items-center gap-1 px-2 py-1.5 bg-green-50 border border-green-200 rounded-full text-xs font-medium text-green-700 hover:bg-green-100 transition-colors"
